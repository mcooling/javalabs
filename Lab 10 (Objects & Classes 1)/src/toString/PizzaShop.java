...

{
	...
	//lines 38-40 from the internetcustomer.java exercise
    
	//Edit the list of customers created in the constructor of PizzaShop
	//include 3 new InternetCustomers (you can refer to a subclass by the superclass type)
	...
	customers = new Customer[] { customer1, customer2, customer3}; //passed into getCustomers() method call at line 55
	//intCust = new InternetCustomer[] {customer4};
